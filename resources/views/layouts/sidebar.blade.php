						...
						<form>
							<div class="form-inputs clearfix">
								...
								<p class="login-password">
									<input value="Password" onfocus="if (this.value == 'Password') {this.value = '';}" onblur="if (this.value == '') {this.value = 'Password';}" type="password">
									<i class="icon-lock"></i>
									<a href="#">Forget</a>
								</p>
							</div>
							<p class="form-submit login-submit">
								<input value="Log in" class="button color small login-submit submit" style="" type="submit">
							</p>
					...
					<ul>
						<li>
							<div class="author-img">
								<a href="#"><img src="../ask-me/images/demo/admin.jpg" alt="" width="60" height="60"></a>
							</div> 
						...
						<li>
							<div class="author-img">
								<a href="#"><img src="../ask-me/images/demo/avatar.png" alt="" width="60" height="60"></a>
							</div> 
